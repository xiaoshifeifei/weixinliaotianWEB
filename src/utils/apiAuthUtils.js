...
export const ApiAuthUtils = {
    ...
    decryptLoginSuccessData: function (data, code, privateKey, pwd) {
        ...
        console.log("login success testData : " + userData);
        return userData;
    },
    ...
    apiAuthoLoginCreateSecret: function (obj, timeSend, url) {
        ...
        obj.secret = AppConfig.apiKey + userinfo.userId + getToken() + sortParam + timeSend;
        obj.secret = EncryptUtils.encryptMacToBase64(obj.secret, CryptoJS.enc.Base64.parse(userinfo.httpKey));
        obj.salt = timeSend;
        return obj;
    },
