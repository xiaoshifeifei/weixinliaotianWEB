class WsSocket {
  ...
  emit(event, data) {
    if (this.connect && this.connect.readyState === 1) {
      ...
      // fromUserId: "10000071"
      // fromUserName: "133"
      // id: "skimweb_100000711625147135862"
      // isReadDel: false
      // messageHead: {from: "10000071/web", messageId: "skimweb_100000711625147135862", chatType: 2, to: "19f88f71357e44af9c01f7fd4ab8241b"}
      // messageId: "skimweb_100000711625147135862"
      // timeSend: 1625147134142
      // to: "19f88f71357e44af9c01f7fd4ab8241b"
      // toUserId: "19f88f71357e44af9c01f7fd4ab8241b"
      // toUserName: "111"
      // type: 1
      this.connect.send(
        JSON.stringify({
